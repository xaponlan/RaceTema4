...
students2_tidy <- students2 %>%
  pivot_longer(cols = starts_with("male") | starts_with("female"),  # Selecciona todas las columnas de género
               names_to = c("sex", "class"),  # Separa en dos variables
               names_pattern = "(male|female)_(\\d+)",  # Expresión regular para extraer 'sex' y 'class'
               values_to = "count") 
